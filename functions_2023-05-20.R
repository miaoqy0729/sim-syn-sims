...
# Function to plot cross-correlation function of simulated behaviors generated by two agents 
# @res: time series results generated from running the runModel function above
...
# Function to plot simulated data against human turn-taking pattern from Stivers et al. (2009)
# @res: time series results generated from running the runModel function above
